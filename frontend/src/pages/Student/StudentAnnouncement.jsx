      ...
      <div className="max-w-7xl mx-auto">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Today's Updates</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Events & Deadlines</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Priority Alerts</p>
                </div>
        ...
        <Card className="border-0 shadow-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-lg">
              All important updates and notifications for students
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <Announcement 
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            💡 Pro tip: Check announcements regularly to stay informed about classes, events, and deadlines
          </p>
        </div>
      </div>
    </div>
